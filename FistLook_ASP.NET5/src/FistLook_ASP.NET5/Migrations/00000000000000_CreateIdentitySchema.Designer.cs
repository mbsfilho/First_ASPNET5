...
using FistLook_ASP.NET5.Models;

namespace FistLook_ASP.NET5.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("FistLook_ASP.NET5.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("FistLook_ASP.NET5.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
